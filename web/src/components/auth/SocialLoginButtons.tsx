  ...
  return (
    <div className="space-y-3"> 
      ...
      <button 
        ...
        className="w-full flex items-center justify-center rounded-lg px-4 py-3 bg-black text-white font-jost"
      >
      ...
      <button 
        ...
        className="w-full flex items-center justify-center rounded-lg px-4 py-3 bg-white text-gray-700 border border-gray-200 font-jost"
      >
        <img 
