...
public final class LogExerciseResponse {
    ...
    public LogExerciseResponse(@com.squareup.moshi.Json(name = "id")
    ...
    @org.jetbrains.annotations.NotNull
    public final org.openapitools.client.models.LogExerciseResponse copy(@com.squareup.moshi.Json(name = "id")
    int id, @com.squareup.moshi.Json(name = "user_id")
    int userId, @com.squareup.moshi.Json(name = "exercise_id")
    int exerciseId, @com.squareup.moshi.Json(name = "exercise_name")
    @org.jetbrains.annotations.NotNull
