...
public abstract class RepositoryModule {
    ...
    public abstract com.example.ptchampion.domain.repository.AuthRepository bindAuthRepository(@org.jetbrains.annotations.NotNull
    com.example.ptchampion.data.repository.AuthRepositoryImpl impl);
    
    @dagger.Binds
    @javax.inject.Singleton
    @org.jetbrains.annotations.NotNull
    public abstract com.example.ptchampion.domain.repository.LeaderboardRepository bindLeaderboardRepository(@org.jetbrains.annotations.NotNull
    com.example.ptchampion.data.repository.LeaderboardRepositoryImpl impl);
    
    @dagger.Binds
    @javax.inject.Singleton
    @org.jetbrains.annotations.NotNull
    public abstract com.example.ptchampion.domain.repository.UserRepository bindUserRepository(@org.jetbrains.annotations.NotNull
    com.example.ptchampion.data.repository.UserRepositoryImpl impl);
