...
public final class InsertUserExercise {
    ...
    public InsertUserExercise(@com.squareup.moshi.Json(name = "userId")
    ...
    public final org.openapitools.client.models.InsertUserExercise copy(@com.squareup.moshi.Json(name = "userId")
    int userId, @com.squareup.moshi.Json(name = "exerciseId")
    int exerciseId, @com.squareup.moshi.Json(name = "repetitions")
    @org.jetbrains.annotations.Nullable
    java.lang.Integer repetitions, @com.squareup.moshi.Json(name = "formScore")
