...
public abstract interface WorkoutApiService {
    ...
    @retrofit2.http.GET(value = "/api/v1/workouts/{workoutId}")
    @org.jetbrains.annotations.Nullable
    public abstract java.lang.Object getWorkoutById(@retrofit2.http.Path(value = "workoutId")
    @org.jetbrains.annotations.NotNull
