...
interface LeaderboardApi {
     ...
     */
    @GET("leaderboards/local")
    fun handleGetLocalLeaderboard(@Query("exercise_id") exerciseId: kotlin.Int, @Query("latitude") latitude: kotlin.Double, @Query("longitude") longitude: kotlin.Double, @Query("radius_meters") radiusMeters: kotlin.Double? = 8047.0): Call<kotlin.collections.List<HandleGetLocalLeaderboard200ResponseInner>>
    ...
    */
     ...
     */
    @GET("leaderboard/{exerciseType}")
    fun leaderboardExerciseTypeGet(@Path("exerciseType") exerciseType: kotlin.String, @Query("limit") limit: kotlin.Int? = 20): Call<kotlin.collections.List<LeaderboardResponseInner>>
