...
interface ExercisesApi {
     ...
     * @return [PaginatedExerciseHistoryResponse]
     */
    @GET("exercises")
    suspend fun exercisesGet(@Query("page") page: kotlin.Int? = 1, @Query("pageSize") pageSize: kotlin.Int? = 20): Response<PaginatedExerciseHistoryResponse>
     ...
     */
    @POST("exercises")
    suspend fun exercisesPost(@Body logExerciseRequest: LogExerciseRequest? = null): Response<LogExerciseResponse>
